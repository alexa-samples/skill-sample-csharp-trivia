...
5.  **Paste your Lambda's ARN (Amazon Resource Name) into the textbox provided.**  It should look similar to the screenshot above and should be everything after the "ARN-" so it's: arn:aws:lambda:us-east:xxxxxxxxxxxx:function:YourFunctionName
